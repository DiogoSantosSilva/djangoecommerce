...
from .views import SellerProductsView, SellerAddView, SellerDetailView, AccountAddress, AccountUpdate, AccountsAddressDelete, UserAddCreateView
...
urlpatterns = [
    ...
    url(r'^address-add/$', UserAddCreateView.as_view(), name='address_add'),
