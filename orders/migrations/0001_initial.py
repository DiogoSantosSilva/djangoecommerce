    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(default=b'created', max_length=120, choices=[(b'created', b'Created'), (b'paid', b'Paid'), (b'shippend', b'Shipped')])),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(related_name='billing_address', to='orders.UserAdress', null=True),
        ),
        migrations.AddField(
            model_name='order',
            name='cart',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(related_name='shipping_address', to='orders.UserAdress', null=True),
        ),
        migrations.AddField(
            model_name='order',
            name='user',
